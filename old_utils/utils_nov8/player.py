...
if __name__ == '__main__':
    # Create a player
    player = Player(13, 200, 6, running_batch_file='nov8/batch_file.pkl', fnet='nov8/latest.model', load_running_batch=True)
    player.self_play(1000, 'nov8/', logging=True, log_file='nov8/training_continued_log.txt', game_offset=37)
